...
public class BookingController {
	...
	public Adaptor getAvailableVehiclesInPeriodByType(String vehicleType, Date s, Date e)
	{
		return manager.getAvailableVehiclesInPeriodByType(vehicleType, s, e);
	}

	public Vehicle getVehicleByNumberPlates(String numberPlates) {
		
		return manager.getVehicleByNumberPlates(numberPlates);
	}
